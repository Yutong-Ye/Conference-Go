...
class PresentationListEncoder(ModelEncoder):
    ...
    def encode(self, obj):
        data = super(PresentationListEncoder, self).encode(obj)
        data["href"] = reverse('presentation_detail', kwargs={'id': obj.id})
        return data
...
def api_show_presentation(request, presentation_id):
    try:
